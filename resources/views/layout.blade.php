        ...
        <div class="footer-cotainer d-flex justify-content-center flex-column">
            ...
            <div class="footer-content d-flex justify-content-center">
                <div class="footer-content__left d-flex flex-column py-5">
                    <span class="text-light pe-5 fs-5">Họ tên: Lưu Quang Khải - Nguyễn Mạnh Hùng</span>
                    <span class="text-light pe-5 fs-5">Khóa: KS</span>
                    <span class="text-light pe-5 fs-5">MSSV: S102165 - 91065</span>
                </div>
